...
CHttpPostBinaryRefArgument::CHttpPostBinaryRefArgument( LPCTSTR argName, const CStringATL fileName, LPCSTR pBuffer, DWORD length, LPCTSTR contentType /*= _T( "application/octet-stream" ) */ ) : ArgName( argName ), FileName( fileName ), PBuffer( pBuffer ), Length( length ), ContentType( contentType )
{
