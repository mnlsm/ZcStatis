...
class OkoooStat : 
	public CAxDialogImpl<OkoooStat>,
	public CWinDataExchange<OkoooStat> {
public:
	OkoooStat(const std::shared_ptr<SQLite::Database>& db);

public:
	enum { IDD = IDD_DANLUE_STAT};

public:
	BEGIN_DDX_MAP(OkoooStat)
	...
	BEGIN_MSG_MAP(OkoooStat)
		...
		CHAIN_MSG_MAP(CAxDialogImpl<OkoooStat>)
...
private:
	CSortListViewCtrlEx<OkoooStat> m_lstResult;
