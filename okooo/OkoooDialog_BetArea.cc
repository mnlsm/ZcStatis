...
LRESULT OkoooDialog::OnBetAreaLButtonDown(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
...
LRESULT OkoooDialog::OnBetAreaEraseBkgnd(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
	return TRUE;
}

LRESULT OkoooDialog::OnBetAreaPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
...
void OkoooDialog::DrawBetAreaTitle(CDCHandle dc, const CRect& rcc, int& yTop) {
...
void OkoooDialog::DrawSPF(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 80;
	int itemHeight = 40;
...
void OkoooDialog::DrawJQZS(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 80;
	int itemHeight = 40;
...
void OkoooDialog::DrawBQC(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 80;
	int itemHeight = 40;
...
void OkoooDialog::DrawBF(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 60;
	int itemHeight = 40;
