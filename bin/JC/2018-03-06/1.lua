...
kMatchDesc = "8串1过滤";
kMatchBets = {
    "20180306004;-1;6,3,1.57",         --广州恒大   VS   济州联
    "20180306011;1;6,3,3.72;6,1,3.05;1,1,3.35",         --伯明翰   VS   米德尔斯堡
    "20180306012;1;6,3,4.30;6,1,3.50;1,1,3.35",         --伯顿   VS   布伦特福德
    "20180306013;-1;6,1,3.65;1,3,2.50;1,1,3.30",         --加的夫城   VS   巴恩斯利
    "20180306014;-1;6,1,3.45;6,0,3.80;1,3,3.25;1,1,3.45",         --富勒姆   VS   谢菲尔德联
    "20180306015;-1;6,0,2.92;1,3,4.70;1,1,3.75",         --赫尔城   VS   米尔沃尔
    "20180306016;-1;6,1,3.30;6,0,4.40;1,3,3.15;1,1,3.30",         --诺维奇   VS   诺丁汉森林
    "20180306022;-1;6,3,1.37",         --什鲁斯伯里   VS   约维尔
};
...
function IsFilterLua(params)
	...
	if (odds_4 > 2 or odds_4 < 1) then 
		ret.code = 1;
		ret.info = trace_prefix .. "odds_4=" .. (odds_4);
		trace(1, ret.info);
		return ret;	
	end
