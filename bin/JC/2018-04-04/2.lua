...
kMatchDesc = "混合过滤";
kMatchBets = {
    "20180404015;-1;6,3,1.38;6,1,4.05",         --            都灵   VS   克罗托内      
    "20180404022;-1;6,3,1.51;6,1,3.55",         --      佩纳罗尔   VS   图库曼竞技   
    "20180404025;-1;6,3,1.30;6,1,4.20",         --      克鲁塞罗   VS   瓦斯科达伽马
};
...
function IsFilterLua(params)
	...
	ok_count = 0;
	ok_count = GetMatchResultCount(6, 1, codes);
