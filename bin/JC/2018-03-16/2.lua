...
kMatchDesc = "混合过滤";
kMatchBets = {
    "20180316003;-1;6,3,1.49;6,1,4.00",         --            基尔   VS   海登海姆      
    "20180316007;-1;6,3,1.43;6,1,3.85",         --         洛里昂   VS   奥尔良         
    "20180316008;-1;6,3,1.70;6,1,3.55",         --            索肖   VS   图尔            
    "20180316028;-1;6,3,1.45;6,1,3.65",         --罗萨里奥中央   VS   查卡里塔青年
};
...
function IsFilterLua(params)
	...
	ok_count = 0;
	ok_count = GetMatchResultCount(6, 1, codes); --ping
	ret.info = trace_prefix .. "ok_count_2=" .. (ok_count);
	trace(1, ret.info);
	if(ok_count > 1 or ok_count < 1) then
		ret.code = 1;
		return ret;
	end
