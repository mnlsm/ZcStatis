...
kMatchBets = {
    ...
    "300;0;-1;6,3,1.92;6,1,3.10;6,0,4.27",    --           希伯尼安  VS  圣约翰斯通         
    "305;0;-1;6,3,1.83;6,1,3.58;6,0,3.91",    --           伊尔维斯  VS  玛丽港             
    "311;0;-1;6,3,1.74;6,1,3.92;6,0,4.17",    --           格罗宁根  VS  坎布尔             
    "321;1;1;1,1,4.54;1,0,1.90",              --             西汉姆  VS  曼城               
    "327;0;-1;6,3,1.88;6,1,3.51;6,0,3.84",    --               赫根  VS  卡尔马             
};
...
function IsFilterLua(params)
	...
	-- [294], [葡甲], [雷克斯欧斯  VS  卡萨皮亚]
	local code_1_3 = GetIndexCodeCount(1, codes, 1, 3);         --场次1的3的个数
	local code_1_1 = GetIndexCodeCount(1, codes, 1, 1);         --场次1的1的个数
	local code_1_0 = GetIndexCodeCount(1, codes, 1, 0);         --场次1的3的个数
	local pan_1_1 = GetIndexPanCount(1, codes, 1);              --场次1的上盘1的个数
	local pan_1_2 = GetIndexPanCount(1, codes, 2);              --场次1的上盘2的个数
	local pan_1_up = pan_1_1 + pan_1_2;                         --场次1的上盘的个数
	local pan_1_down = GetIndexPanCount(1, codes, -2);          --场次1的下盘的个数

	-- [300], [苏超], [希伯尼安  VS  圣约翰斯通]
	local code_2_3 = GetIndexCodeCount(2, codes, 6, 3);         --场次2的3的个数
	local code_2_1 = GetIndexCodeCount(2, codes, 6, 1);         --场次2的1的个数
	local code_2_0 = GetIndexCodeCount(2, codes, 6, 0);         --场次2的3的个数
	...
	local pan_6_down = pan_6_3 + pan_6_4;                       --场次6的下盘的个数
	 ...
	 -- stat items
	local code_0_sum = code_2_0 + code_3_0 + code_4_0 + code_6_0;
	local code_1_sum = code_2_1 + code_3_1 + code_4_1 + code_6_1;
	local code_3_sum = code_2_3 + code_3_3 + code_4_3 + code_6_3;
	local pan_1_sum = pan_1_1 + pan_5_1;
	local pan_2_sum = pan_1_2 + pan_5_2;
	local pan_3_sum = pan_2_3 + pan_3_3 + pan_4_3 + pan_6_3;
	local pan_4_sum = pan_2_4 + pan_3_4 + pan_4_4 + pan_6_4;
	...
	local rq_code_0_sum = code_1_0 + code_5_0;
	local rq_code_1_sum = code_1_1 + code_5_1;
	local rq_code_3_sum = code_1_3 + code_5_3;
