...
LRESULT BeiDanDialog::OnBetAreaLButtonDown(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
...
LRESULT BeiDanDialog::OnBetAreaEraseBkgnd(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
	return TRUE;
}

LRESULT BeiDanDialog::OnBetAreaPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
...
void BeiDanDialog::DrawBetAreaTitle(CDCHandle dc, const CRect& rcc, int& yTop) {
...
void BeiDanDialog::DrawSPF(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 80;
	int itemHeight = 40;
...
void BeiDanDialog::DrawJQZS(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 80;
	int itemHeight = 40;
...
void BeiDanDialog::DrawBQC(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 80;
	int itemHeight = 40;
...
void BeiDanDialog::DrawBF(CDCHandle dc, const CRect& rcc, int& yTop) {
	int saveDC = dc.SaveDC();
	dc.SetBkMode(TRANSPARENT);
	int itemWidth = 60;
	int itemHeight = 40;
